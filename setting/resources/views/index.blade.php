                            ...
                            <div class="ui-select-wrapper">
                                <select name="locale" class="ui-select form-control select-search-full" id="locale">
                                    @php
                                        ...
                                        if (app()->environment('demo') && session('site-locale') && array_key_exists(session('site-locale'), \Admingate\Base\Supports\Language::getAvailableLocales())) {
                                            $defaultLocale = session('site-locale');
                                        }
                                    @endphp
                                    @foreach (\Admingate\Base\Supports\Language::getAvailableLocales() as $key => $locale)
