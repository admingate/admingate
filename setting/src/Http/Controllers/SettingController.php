...
namespace Admingate\Setting\Http\Controllers;

use Assets;
use BaseHelper;
use Admingate\Base\Http\Controllers\BaseController;
use Admingate\Base\Http\Responses\BaseHttpResponse;
use Admingate\Base\Supports\Core;
use Admingate\Base\Supports\Language;
use Admingate\Media\Repositories\Interfaces\MediaFileInterface;
use Admingate\Setting\Http\Requests\EmailTemplateRequest;
use Admingate\Setting\Http\Requests\LicenseSettingRequest;
use Admingate\Setting\Http\Requests\MediaSettingRequest;
use Admingate\Setting\Http\Requests\ResetEmailTemplateRequest;
use Admingate\Setting\Http\Requests\SendTestEmailRequest;
use Admingate\Setting\Http\Requests\SettingRequest;
use Admingate\Setting\Repositories\Interfaces\SettingInterface;
use Carbon\Carbon;
use EmailHandler;
use Exception;
