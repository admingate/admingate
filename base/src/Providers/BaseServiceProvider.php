...
use BaseHelper;
use Admingate\Base\Exceptions\Handler;
use Admingate\Base\Facades\BaseHelperFacade;
use Admingate\Base\Hooks\EmailSettingHooks;
use Admingate\Base\Http\Middleware\CoreMiddleware;
use Admingate\Base\Http\Middleware\DisableInDemoModeMiddleware;
use Admingate\Base\Http\Middleware\HttpsProtocolMiddleware;
use Admingate\Base\Http\Middleware\LocaleMiddleware;
use Admingate\Base\Models\AdminNotification;
use Admingate\Base\Models\MetaBox as MetaBoxModel;
use Admingate\Base\Repositories\Caches\MetaBoxCacheDecorator;
use Admingate\Base\Repositories\Eloquent\MetaBoxRepository;
use Admingate\Base\Repositories\Interfaces\MetaBoxInterface;
use Admingate\Base\Supports\Action;
use Admingate\Base\Supports\BreadcrumbsManager;
use Admingate\Base\Supports\CustomResourceRegistrar;
use Admingate\Base\Supports\Database\Blueprint;
use Admingate\Base\Supports\Filter;
use Admingate\Base\Supports\GoogleFonts;
use Admingate\Base\Supports\Helper;
use Admingate\Base\Traits\LoadAndPublishDataTrait;
use Admingate\Base\Widgets\AdminWidget;
use Admingate\Base\Widgets\Contracts\AdminWidget as AdminWidgetContract;
use Admingate\Setting\Providers\SettingServiceProvider;
use Admingate\Setting\Supports\SettingStore;
use Admingate\Support\Http\Middleware\BaseMiddleware;
use DateTimeZone;
...
class BaseServiceProvider extends ServiceProvider
{
    ...
    public function registerDefaultMenus()
    {
        dashboard_menu()
            ->registerItem([
                'id' => 'cms-core-admingate-administration',
                'priority' => 999,
                'parent_id' => null,
