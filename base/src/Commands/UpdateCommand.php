...
namespace Admingate\Base\Commands;
    ...
    public function handle(): int
    {
        ...
        if ($updateData['status']) {
            ...
            $array = [
                ...
                'It will override all files in admingate/core, admingate/packages, all plugins developed by us in admingate/plugins and theme developed by us in admingate/themes.',
            ];
