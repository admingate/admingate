...
namespace Admingate\Base\Supports;

use BaseHelper;
use Admingate\Base\Events\UpdatedEvent;
use Admingate\Base\Events\UpdatingEvent;
use Admingate\PluginManagement\Services\PluginService;
use Admingate\Theme\Services\ThemeService;
use Exception;
...
final class Core
{
    ...
    {
        $this->apiUrl = 'https://license.admingate.com';
    ...
    private function validateUpdateFile(string $filePath): bool
    {
        ...
        if ($zip->open($filePath)) {
            ...
            $content = json_decode($zip->getFromName('admingate/core/core.json'), true);
