...
use Admingate\Base\Facades\DashboardMenuFacade;
use Admingate\Base\Facades\PageTitleFacade;
use Admingate\Base\Supports\DashboardMenu;
use Admingate\Base\Supports\Editor;
...
if (! function_exists('platform_path')) {
    ...
    {
        return base_path('admingate/' . $path);
    }
}
