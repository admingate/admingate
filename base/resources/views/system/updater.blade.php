    ...
    <div class="container">
        ...
        <div class="updater-box" dir="ltr">
            <div class="note note-warning">
                ...
                <p>- It will override all files in <strong>admingate/core</strong>, <strong>admingate/packages</strong>, all plugins developed by us in <strong>admingate/plugins</strong> and theme developed by us in <strong>admingate/themes</strong>.</p>
            </div>
