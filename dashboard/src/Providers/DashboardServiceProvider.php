...
namespace Admingate\Dashboard\Providers;

use Admingate\Base\Traits\LoadAndPublishDataTrait;
use Admingate\Dashboard\Models\DashboardWidget;
use Admingate\Dashboard\Models\DashboardWidgetSetting;
use Admingate\Dashboard\Repositories\Caches\DashboardWidgetCacheDecorator;
use Admingate\Dashboard\Repositories\Caches\DashboardWidgetSettingCacheDecorator;
use Admingate\Dashboard\Repositories\Eloquent\DashboardWidgetRepository;
use Admingate\Dashboard\Repositories\Eloquent\DashboardWidgetSettingRepository;
use Admingate\Dashboard\Repositories\Interfaces\DashboardWidgetInterface;
