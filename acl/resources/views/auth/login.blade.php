...
@section('content')
    ...
    {!! Form::open(['route' => 'access.login', 'class' => 'login-form']) !!}
        <div class="form-group mb-3" id="emailGroup">
            ...
            {!! Form::text('username', request()->input('email', old('username', app()->environment('demo') ? config('core.base.general.demo.account.username', 'admingate') : null)), ['class' => 'form-control', 'placeholder' => trans('core/acl::auth.login.username')]) !!}
        </div>
        ...
        {!! apply_filters(BASE_FILTER_AFTER_LOGIN_OR_REGISTER_FORM, null, \Admingate\ACL\Models\User::class) !!}
