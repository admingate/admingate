...
namespace Admingate\ACL\Http\Controllers;

use Assets;
use Admingate\Base\Events\UpdatedContentEvent;
use Admingate\Media\Services\ThumbnailService;
use Carbon\Carbon;
use Illuminate\Support\Facades\File;
use Illuminate\Support\Facades\Auth;
use Admingate\ACL\Forms\PasswordForm;
use Admingate\ACL\Forms\ProfileForm;
use Admingate\ACL\Forms\UserForm;
use Admingate\ACL\Tables\UserTable;
use Admingate\ACL\Http\Requests\CreateUserRequest;
use Admingate\ACL\Http\Requests\UpdatePasswordRequest;
use Admingate\ACL\Http\Requests\UpdateProfileRequest;
...
use Admingate\ACL\Services\ChangePasswordService;
use Admingate\ACL\Services\CreateUserService;
...
use Admingate\ACL\Http\Requests\AvatarRequest;
use Exception;
