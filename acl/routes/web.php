...
use Admingate\ACL\Http\Controllers\Auth\ForgotPasswordController;
use Admingate\ACL\Http\Controllers\Auth\LoginController;
use Admingate\ACL\Http\Controllers\Auth\ResetPasswordController;
use Admingate\ACL\Http\Controllers\UserController;

Route::group(['namespace' => 'Admingate\ACL\Http\Controllers', 'middleware' => ['web', 'core']], function () {
